...
answer_holder="";
score=0;
document.getElementById("ys").innerHTML="sketch drawn"+sketch
function setup(){
    ...
    function updateCanvas() {
        ...
        sketch = quick_draw_data_set[random_number];
        document.getElementById('ys').innerHTML = 'Sketch To be Drawn: ' + sketch;
      }
      function preload(){
  ...
  if(draw_sketch == sketch)
  {
    ...
    function gotResult(error, results) {
        ...
        document.getElementById('ys').innerHTML = 'Your Sketch: ' + drawn_sketch;
